        ...
        >
            <div class="flex flex-col justify-center items-center h-[100vh]">
                <div id="dialog" class="text-white items-center flex flex-col bg-[#252525] justify-center p-[24px] focus:ring-1 focus:ring-violet-300">
                    ...
                    <div class="w-[452px] h-[162px]"> 
                        <h2 class="text-white font-medium text-base">Connect to local server</h2>
                        <div class="text-[13px] mt-[4px] mb-[13px] pb-[24px] text-[#999999]">
                            <p>
                                "To connect to a computer in your LAN, paste its local IP below."
                            </p>
                            <form class="my-3">
                                <input type="text" class="py-[4px] px-[6px] rounded-sm bg-transparent border-violet-300 border-[1px] focus:ring-1 focus:ring-violet-300" placeholder="192.168.43.174"/>
                            </form>
                        </div>
                        <div class="flex justify-end items-center">
